...
//View Class co ban de nguoi dung goi den khi tuong tac voi Model
//If there are a lot of Views use scenario to build IU, we can use baseView in order to avoid coinciding
